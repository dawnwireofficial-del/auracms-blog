                ...
                <div className="tf-product-info-list relative flex-grow">
                    ...
                    <div className="tf-product-info-trust-seal">
                        ...
                        <div className="tf-payment flex gap12 flex-wrap">
                            <Image width={50} height={32} src="/images/payment/img-1.png" alt="image" />
                            <Image width={50} height={32} src="/images/payment/img-2.png" alt="image" />
                            <Image width={50} height={32} src="/images/payment/img-3.png" alt="image" />
                            <Image width={50} height={32} src="/images/payment/img-4.png" alt="image" />
                            <Image width={50} height={32} src="/images/payment/img-5.png" alt="image" />
                            <Image width={50} height={32} src="/images/payment/img-6.png" alt="image" />
                        </div>
                    </div>
                </div>
            </div>
