...
export default function NeuralOrb({
  ...
  return (
    <div className={`relative flex items-center justify-center ${dimensions} ${className}`}>
      ...
      {/* Main Core Orb */}
      <motion.div
        className="w-3/4 h-3/4 rounded-full bg-gradient-to-tr from-[#246BFF] via-cyan-400 to-indigo-600 shadow-lg shadow-[#246BFF]/40 flex items-center justify-center relative overflow-hidden"
        animate={{
