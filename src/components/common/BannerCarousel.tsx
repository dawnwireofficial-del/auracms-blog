            ...
            {current.ctaText && (
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-[#246BFF] to-[#4F7CFF] hover:from-dw-blue-700 hover:to-dw-blue-600 text-white font-extrabold px-6 py-3 rounded-2xl text-xs shadow-xl shadow-dw-blue/30 transition-all hover:scale-105"
                >
