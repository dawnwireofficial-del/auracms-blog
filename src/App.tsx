...
export default function App({ initialData, routeSpecific, initialRoute }: AppProps) {
  ...
  const navigateTo = (routeName: string, param?: string) => {
    ...
    else if (routeName === 'review' && param) newPath = `/review/${param}`;
    else if (routeName === 'portfolio' && param) newPath = `/portfolio/${param}`;
    else if (routeName === 'posts-by-category' && param) newPath = `/category/${param}`;
    else if (routeName === 'page' && param) newPath = `/page/${param}`;
    else if (routeName === 'products') newPath = '/products';
    else if (routeName === 'contact') newPath = '/contact';
    else if (routeName === 'admin') newPath = '/admin';
    else if (routeName === 'about') newPath = '/about';
    else if (routeName === 'services') newPath = '/services';
    else if (routeName === 'service-detail' && param) newPath = `/services/${param}`;
    else if (routeName === 'advertise') newPath = '/advertise';
    else if (routeName === 'submit-product') newPath = '/submit-product';
    else if (routeName === 'case-studies') newPath = '/case-studies';
    else if (routeName === 'newsletter') newPath = '/newsletter';
    else if (routeName === 'editorial-policy') newPath = '/editorial-policy';
    else if (routeName === 'affiliate-disclosure') newPath = '/affiliate-disclosure';
    else if (routeName === 'privacy') newPath = '/privacy';
    else if (routeName === 'terms') newPath = '/terms';
    else if (routeName === 'articles') newPath = '/articles';
    else if (routeName === 'cluster' && param) newPath = `/cluster/${param}`;
    else if (routeName === 'buyers-guide' && param) newPath = `/buyers-guide/${param}`;
    else if (routeName === 'buyers-guide') newPath = '/buyers-guide';
    else if (routeName === 'category' && param) newPath = `/browse/${param}`;
    else if (routeName === 'product' && param) newPath = `/product/${param}`;
